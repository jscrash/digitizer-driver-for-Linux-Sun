/* DEC/CMS REPLACEMENT HISTORY, Element MD_VERIFY_SQL.C*/
/* *2    17-AUG-1990 21:58:51 VINCE "(SPR 5644) Code Cleanup"*/
/* *1    19-JUN-1989 13:07:45 SYSTEM ""*/
/* DEC/CMS REPLACEMENT HISTORY, Element MD_VERIFY_SQL.C*/
/*****************************************************************************/
/******************************************************************************
...
Prototype:
    publicdef INT md_verify_sql(MD_KEY_INFO *key_info,CHAR parm_string[MD_MAX_PARM_STRING],
...
/* BEGIN:   */
#if USE_PROTOTYPES
publicdef INT md_verify_sql (MD_KEY_INFO *key_info,
                             CHAR parm_string[MD_MAX_PARM_STRING],
                             MD_PARM_STRUCT **parmstruc)
#else
publicdef INT md_verify_sql (key_info, parm_string, parmstruc)
