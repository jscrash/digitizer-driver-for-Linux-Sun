/* DEC/CMS REPLACEMENT HISTORY, Element LH_FIRST.C*/
/* *1    19-JUN-1989 13:05:59 SYSTEM ""*/
/* DEC/CMS REPLACEMENT HISTORY, Element LH_FIRST.C*/
...
INT lh_first(header_pointer, key_pointer, data_pointer, data_length)
/************************* lh_first *********************************
-FUNCTION:  This routine returns the key and data of the initial list
            node.
...
-DESCRIPTION:
  ...
  This routine returns a copy of the first list element.  If that field
  is NULL, then an error return is given.
