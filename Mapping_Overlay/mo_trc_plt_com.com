$! DEC/CMS REPLACEMENT HISTORY, Element MO_TRC_PLT_COM.COM
$! *1    19-JUN-1989 14:57:27 SYSTEM ""
$! DEC/CMS REPLACEMENT HISTORY, Element MO_TRC_PLT_COM.COM
$!* ------------------------------------------------------------     
$!*			 TRACEPLOTS....
...
$        TMP_FILE = "''USER'_TRC_''F$EXT(F$LEN(TOD)-2,999,TOD)'.COM"
$        OPEN/WRITE/ERROR=OPEN_ERROR TMP 'TMP_FILE'
$        
$        WRITE TMP "$MODEL_PLOT := $PLOT_BIN_DIR:MO_TRC_PLOTTER.EXE"
