/* DEC/CMS REPLACEMENT HISTORY, Element SL_ISEL_LYNX.C */
/* *2    30-JUL-1990 17:24:40 JULIAN "(SPR 0) add lynx,lease select_list" */
/* *1    30-JUL-1990 17:17:30 JULIAN "init lynx nlist" */
/* DEC/CMS REPLACEMENT HISTORY, Element SL_ISEL_LYNX.C */
...
publicdef INT slz_init_lynx_sl(select_list )
NLIST_HEADER *select_list;   /* nlist */
{
    ...
    static size_t data_sizes[1] = { sizeof ( INT ) };
    static INT data_types[1] = { INT_TYPE };
    static INT value_inc[1] = { VALUE_LIST };
    static UINT dim_list[1] = { 1 };
    static CHAR *c_name[2] = {"LYNX_ID",NULL };
...
/* set the default values into the user structure */
    status = sl_fill_select_struct(LYNX_DATA_TYPE, *select_list );
    return status;
}
