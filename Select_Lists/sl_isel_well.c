/* DEC/CMS REPLACEMENT HISTORY, Element SL_ISEL_WELL.C */
/* *2    30-JUL-1990 17:24:52 JULIAN "(SPR 0) add lynx,lease select_list" */
/* *1    30-JUL-1990 17:18:31 JULIAN "init wells nlist" */
/* DEC/CMS REPLACEMENT HISTORY, Element SL_ISEL_WELL.C */
...
/* *************************************************************************
    ...
    ********************************************************************** */
publicdef INT slz_init_well_sl(select_list )
...
/* set the default values into the user structure */
    status = sl_fill_select_struct(WELLS_DATA_TYPE, *select_list );
    return status;
}
