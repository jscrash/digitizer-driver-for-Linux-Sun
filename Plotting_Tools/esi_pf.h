...
extern publicdef INT pf_post_overlay (PF_INFO *pf);
extern publicdef INT pf_get_clip_extent (PF_INFO *pf,DOUBLE *ndc_ll_x,DOUBLE *ndc_ll_y,DOUBLE *ndc_ur_x,DOUBLE *ndc_ur_y);
extern publicdef INT pf_read_parfile (PATHNAME metafile,DOUBLE *vdc_ll_x,DOUBLE *vdc_ll_y,DOUBLE *vdc_ur_x,DOUBLE *vdc_ur_y);
...
extern publicdef INT pf_post_overlay ();
extern publicdef INT pf_get_clip_extent ();
extern publicdef INT pf_read_parfile ();
